...
export class Token extends Entity {
  ...
  get glmrPrice(): BigDecimal | null {
    let value = this.get("glmrPrice");
    if (value === null || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toBigDecimal();
  ...
  set glmrPrice(value: BigDecimal | null) {
    if (value === null) {
      this.unset("glmrPrice");
    } else {
      this.set("glmrPrice", Value.fromBigDecimal(value as BigDecimal));
    }
  }
  ...
  get liquidityInGlmr(): BigDecimal | null {
    let value = this.get("liquidityInGlmr");
    if (value === null || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toBigDecimal();
  ...
  set liquidityInGlmr(value: BigDecimal | null) {
    if (value === null) {
      this.unset("liquidityInGlmr");
    } else {
      this.set("liquidityInGlmr", Value.fromBigDecimal(value as BigDecimal));
    }
  }
...
export class SwapPairFeeInfoByLast extends Entity {
  ...
  get glmrPrice(): BigDecimal {
    let value = this.get("glmrPrice");
    return value.toBigDecimal();
  }

  set glmrPrice(value: BigDecimal) {
    this.set("glmrPrice", Value.fromBigDecimal(value));
  }
...
export class Pool extends Entity {
  ...
  get rewardInfos(): Array<string | null> {
    let value = this.get("rewardInfos");
    return value.toStringArray();
  }

  set rewardInfos(value: Array<string | null>) {
    this.set("rewardInfos", Value.fromStringArray(value));
  }
...
export class RewardInfo extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save RewardInfo entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save RewardInfo entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("RewardInfo", id.toString(), this);
  }

  static load(id: string): RewardInfo | null {
    return store.get("RewardInfo", id) as RewardInfo | null;
  }
  ...
  get rewardSymbol(): string {
    let value = this.get("rewardSymbol");
    return value.toString();
  }

  set rewardSymbol(value: string) {
    this.set("rewardSymbol", Value.fromString(value));
  }
  ...
  get rewarderIdx(): BigInt {
    let value = this.get("rewarderIdx");
    return value.toBigInt();
  }

  set rewarderIdx(value: BigInt) {
    this.set("rewarderIdx", Value.fromBigInt(value));
  }
}
